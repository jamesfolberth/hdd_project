...
\begin{frame}{Manually selecting features}
   \begin{itemize}
      \item A na\"ive option is to manually select some number of features from a large list of features.
      \item We combined various simple features, the mean and variance of the MFCCs, and features from WCHs into a length $66$ vector.
