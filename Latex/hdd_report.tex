...
\vspace{55mm}
\item{\bf{Fully Connected Graph:}} Below in Figure \ref{fig:G3} we have the fully connected graph using all three methods. We see that the Unnormalized Method performed the best till we get to the higher number of eigenvectors and Normalized Method 2 performed the best. 
\begin{figure}[h!]
   \centering
